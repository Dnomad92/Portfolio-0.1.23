  ...
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid justify-items-center max-w-lg grid-cols-3 gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-4 sm:gap-x-10 lg:mx-auto lg:max-w-6xl lg:grid-cols-5">
          ...
          <GithubLogo className="h-28 w-auto"/>
